...
import type { TopicProblem, TopicProblemQueryParams } from '@/types'
const { proxy } = getCurrentInstance() as ComponentInternalInstance
const problemList = ref<TopicProblem[]>([]); const loading = ref(true); const showSearch = ref(true); const total = ref(0); const open = ref(false); const title = ref(''); const ids = ref<string[]>([]); const single = ref(true)
